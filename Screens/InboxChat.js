  ...
  render() {
    ...
    return (
        ...
        {locationAddress ? <View>
          ...
          <Button
            title={!imageName1 ? "image1" : imageName1.slice(imageName1.length - 20,imageName1.length)}
            onPress={() => this.pickImage('image1')}
          />
          <Button
            title={!imageName2 ? "image2" : imageName2.slice(imageName2.length - 20,imageName2.length)}
            onPress={() => this.pickImage('image2')}
          />
          <Button
            title={!imageName3 ? "image3" : imageName3.slice(imageName3.length - 20,imageName3.length)}
